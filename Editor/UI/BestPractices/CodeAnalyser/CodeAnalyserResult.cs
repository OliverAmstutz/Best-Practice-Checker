...
namespace BestPracticeChecker.Editor.UI.BestPractices.CodeAnalyser
{
    public sealed class CodeAnalyserResult : ResultEditor
    {
        ...
        protected override void DisplayResult()
        {
            if (_result == null && _bestPractice != null)
                _result = (CodeAnalyserResultContent) _bestPractice.GetResult();
