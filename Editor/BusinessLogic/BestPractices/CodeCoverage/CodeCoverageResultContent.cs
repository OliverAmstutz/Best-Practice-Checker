...
{
    [Serializable]
    public sealed class CodeCoverageResultContent : IResult
    {
        ...
        public string Content()
        {
            return status switch
            {
                ...
                PackageStatus.Outdated => "Your code coverage package is outdated. Please update manually or through the \"fix\" button.",
