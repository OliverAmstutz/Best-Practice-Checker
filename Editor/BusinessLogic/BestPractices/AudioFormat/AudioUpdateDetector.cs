...
namespace BestPracticeChecker.Editor.BusinessLogic.BestPractices.AudioFormat
{
    public sealed class AudioUpdateDetector : AssetPostprocessor
    {
        ...
        /// <summary>
        ///     Deleted Assets callbacks are only available after deletion, no means to detect type of deleted asset.
        /// </summary>
        ...
        {
            if (deletedAssets.Length > 0 && ImportAudio != null) ImportAudio();
        }
